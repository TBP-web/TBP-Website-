 ...
 * ---------------------------------------------------------------
 * This file holds the content shown to every visitor of the site.
 *
 * DO NOT edit it by hand. To change the live site:
 *   1. Open admin.html and make your edits (Save each section).
 *   2. Admin > Security & Publishing > "Download content.js for publishing".
 *   3. Replace this file (assets/js/content.js) with the downloaded one.
 *   4. Commit & deploy — the change is now live for everyone.
 *
 * If this file is missing, the site falls back to the defaults baked into
 * assets/js/site-data.js, so the site never breaks.
 */
...
window.TBP_PUBLISHED_CONTENT = {
  ...
  "about": {
    ...
    "stats": [
      ...
      {
        "count": "48",
        "label": "Projects & Drives",
        "prefix": "",
        "suffix": "+"
      },
      {
        "count": "18",
        "label": "Partner Chapters",
        "prefix": "",
        "suffix": "+"
      },
      {
    ...
    "columns": [
      ...
      },
      {
        ...
        "links": [
          ...
          {
            "id": "flink_letter",
            "label": "Letter from Harsh Bhayani",
            "url": "#founder-note"
          }
        ]
      }
